...
RECEIVER_EMAIL = "utai.c@siamintermold.com,wattanapon.s@siamintermold.com,paithoon.b@siamintermold.com,rewat.m@siamintermold.com,thawat.t@siamintermold.com,admincenter@siamintermold.com,waiphop.b@siamintermold.com"
        ...
        <div style="max-width: 600px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="text-align: center;">
                    <a href="https://sim-po-2026-v2.streamlit.app/" style="background-color: {header_color}; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Access System</a>
                </div>
            </div>
